  ...
  projects: Project[] = [
    {
      ...
      description: 'Discord bot written in C# with .NET 5 using the Discord.Net library and MySQL database.',
    ...
    {
      title: 'Text Morph',
      description: 'Web app allowing users to transform text, built with Angular and styled with Tailwind CSS.',
    ...
    {
      title: 'Infection FPS',
      description: 'Multiplayer first-person shooter game created in Unity C# with Mirror Networking.',
    ...
    },
    {
      ...
      description: 'Autonomous self-driving robot car powered by motors and sensors on a Raspberry Pi written in C.',
    ...
    },
    {
      ...
      description: 'Multiplayer Virtual Reality fighting game created in Unity C# using SteamVR SDK. Networking server code written in Java.',
    ...
    },
    {
      ...
      description: 'Full-stack web application built with NodeJS, Express, Bootstrap, and MySQL deployed on AWS.',
    ...
    },
    {
      ...
      description: 'Four player bomberman game written in Java.',
    ...
    },
    {
      ...
      description: 'Two player tank game written in Java.',
